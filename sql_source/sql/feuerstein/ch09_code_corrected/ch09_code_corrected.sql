...
DECLARE
   ...
   test_nbr2  NUMBER(6) := 999999;

-- For the following declaration, no precision is specified, so 40 significant digits are allowed -- there are 40 9's.
-- If precision were specified, we would be limited to only 38 significant digits.
   big_nbr    NUMBER := 9.999999999999999999999999999999999999999e125;
   -- The following declaration is a string of 125 9's.  126 9's does not work!
--   big_nbr    NUMBER := 99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999;
...
BEGIN
   ...
   DBMS_OUTPUT.PUT_LINE ('test_nbr2 = ' || TO_CHAR(test_nbr2));
   DBMS_OUTPUT.PUT_LINE ('test_nbr2 = ' || TO_CHAR(test_nbr2, fmt_nbr));

   test_nbr := test_nbr2 + 1;
   DBMS_OUTPUT.PUT_LINE ('test_nbr2 + 1 = ' || TO_CHAR(test_nbr));
...
BEGIN
   ...
   */
   ...
   int3 := int2 / int1;
   nbr := int2 / int1;
   /* The next two lines are also incorrect:
