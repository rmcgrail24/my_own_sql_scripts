...
column segment_space_management format a7 heading 'Segmnt|Mngment'

break on report
compute sum label Total of bytes blocks on report

ttitle center '***** DBA_TABLESPACES View *****' -
...
SELECT tablespace_name,
       ...
       extent_management
  FROM dba_tablespaces t JOIN dba_data_files d USING (tablespace_name)
